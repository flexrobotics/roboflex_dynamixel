...
PYBIND11_MODULE(roboflex_dynamixel_ext, m) {
    ...
    py::class_<DynamixelGroupController, std::shared_ptr<DynamixelGroupController>>(m, "DynamixelGroupController")
        ...
        .def("set_loop_sleep_ms", &DynamixelGroupController::set_loop_sleep_ms, py::arg("milliseconds"))
        .def("get_loop_sleep_ms", &DynamixelGroupController::get_loop_sleep_ms)
        .def("set_servo_processing_margin_ms", &DynamixelGroupController::set_servo_processing_margin_ms, py::arg("milliseconds"))
        .def("get_servo_processing_margin_ms", &DynamixelGroupController::get_servo_processing_margin_ms)
