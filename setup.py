...
setup(
    ...
    url="https://github.com/flexrobotics/roboflex_dynamixel",
    ...
    license = "MIT",
    python_requires='>=3.6',
    install_requires=['numpy>=2.0', 'roboflex'],
    ext_modules=[CMakeExtension('roboflex/dynamixel/roboflex_dynamixel_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.dynamixel'],
    package_dir={'roboflex.dynamixel': 'python'}
)
